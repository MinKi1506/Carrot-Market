    ...
    <div className="px-5 w-[500px]">
      ...
      <div>
        ...
        <form className="flex flex-col mt-4">
          ...
          <div className="mt-1">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                <span className="flex items-center justify-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">
                  +82
                </span>
                <input
                  id="input"
          ...
          <button className="bg-orange-500 hover:bg-orange-600 text-white mt-2 py-2 px-4 border  border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="bg-white text-center">
              <span className="relative -top-3 bg-white px-2 text-sm text-gray-500">
                Or enter with
              </span>
            </div>
          </div>
