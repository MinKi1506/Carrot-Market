    ...
    <div className="py-10 px-4">
      <div className="flex gap-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <span className="text-gray-600">Edit profile &rarr;</span>
        </div>
      </div>
      <div className="mt-8 flex justify-around">
        <div className="flex flex-col gap-2 items-center">
          <div className="flex bg-orange-500 text-white w-12 h-12 justify-center items-center rounded-full">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
      ...
      <div>
        <div className="mt-8  py-2 w-full border-y-2 border-double border-gray-600">
          거래 후기
        </div>
